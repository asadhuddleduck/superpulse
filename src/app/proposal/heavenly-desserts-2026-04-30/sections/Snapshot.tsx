...
// Slide 2 — Snapshot. Big numbers + a left-scrolling conveyor of brand
// photos underneath. Photos are the only place visual texture from the
// HD brand appears in the deck — kept to one slide so the rest stays
// quiet.
  ...
  return (
    <section id="snapshot">
      ...
      <div className="proposal-slide-inner">
        ...
        {/* Brand vibe — left-scrolling photo conveyor */}
        <div style={{ marginTop: 22, marginLeft: -22, marginRight: -22 }}>
